...
public class SignUpController extends HttpServlet {
    ...
    private static final String FAIL = "sign_up.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (password.equals(confirm)) {
                ...
                Account account = new Account(email, name, "2", true);
                account.setPassword(hexPassword);
                ...
                request.setAttribute("SIGN_UP_ERROR", "Password and Confirm must be the same.");
                url = FAIL;
            }
            ...
            if (e.getMessage().contains("duplicate")) {
                url = FAIL;
                request.setAttribute("SIGN_UP_ERROR", "Email is existed!");
            }
        } finally {
