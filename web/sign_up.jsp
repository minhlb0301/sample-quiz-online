<%-- 
    Document   : sign_up
    Created on : Feb 8, 2021, 6:37:06 PM
    Author     : Minh
--%>
...
<html>
    <head>
        ...
        <title>Sign Up Page | Quiz Online</title>
    </head>
    <body>
        <div class="limiter">
            <div class="container-login100" style="background-image: url('images/bg-01.jpg');">
                <div class="wrap-login100 p-l-110 p-r-110 p-t-62 p-b-33">
                    <form class="login100-form validate-form flex-sb flex-w" method="post" action="signUp">
                        ...
                        <div>
                            <h5 style="color: red">${requestScope.SIGN_UP_ERROR}</h5>
                        </div>
                        ...
                        <div class="wrap-input100 validate-input" data-validate = "Confirm Password is required">
                            <input class="input100" type="password" name="txtConfirm" />
                            <span class="focus-input100"></span>
                        </div>
                        <div class="p-t-13 p-b-9">
                            <span class="txt1">
